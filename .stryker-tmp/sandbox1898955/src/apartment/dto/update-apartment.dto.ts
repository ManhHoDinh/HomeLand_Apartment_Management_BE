...
export class UpdateApartmentDto extends PartialType(OmitType(Apartment, (["apartment_id", "imageURLs", "floor", "building", "created_at", "deleted_at", "contracts", "residents"] as const))) {
  /**
