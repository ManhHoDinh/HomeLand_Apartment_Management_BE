...
export class SeedService {
    ...
    if (stryMutAct_9fa48("1960")) {
      ...
      try {
        ...
        if (stryMutAct_9fa48("1962")) {
          ...
          stryCov_9fa48("1962");
          throw new Error(stryMutAct_9fa48("1963") ? "" : (stryCov_9fa48("1963"), "error"));
        }
      }
    }
  }
    ...
    if (stryMutAct_9fa48("1964")) {
      ...
      try {
        ...
        if (stryMutAct_9fa48("1966")) {
          ...
          stryCov_9fa48("1966");
          throw new Error(stryMutAct_9fa48("1967") ? "" : (stryCov_9fa48("1967"), "error"));
        }
      }
    }
  }
  ...
  private readonly images = stryMutAct_9fa48("1968") ? [] : (stryCov_9fa48("1968"), [({
  ...
  async createDemoApartments(floorInfo: any[]) {
    if (stryMutAct_9fa48("1969")) {
      ...
      stryCov_9fa48("1969");
      let apartmentIds: any[] = stryMutAct_9fa48("1970") ? ["Stryker was here"] : (stryCov_9fa48("1970"), []);
      for (let floor of floorInfo) {
        if (stryMutAct_9fa48("1971")) {
          {}
        } else {
          stryCov_9fa48("1971");
          for (let i = 0; stryMutAct_9fa48("1974") ? i >= this.NUMBER_OF_APARTMENT_PER_FLOOR : stryMutAct_9fa48("1973") ? i <= this.NUMBER_OF_APARTMENT_PER_FLOOR : stryMutAct_9fa48("1972") ? false : (stryCov_9fa48("1972", "1973", "1974"), i < this.NUMBER_OF_APARTMENT_PER_FLOOR); stryMutAct_9fa48("1975") ? i-- : (stryCov_9fa48("1975"), i++)) {
            if (stryMutAct_9fa48("1976")) {
              {}
            } else {
              stryCov_9fa48("1976");
              apartmentIds.push((await this.apartmentService.create(stryMutAct_9fa48("1977") ? {} : (stryCov_9fa48("1977"), {
                name: stryMutAct_9fa48("1978") ? "" : (stryCov_9fa48("1978"), "St. Crytal"),
                images: this.images,
                length: 20,
                building_id: floor.building_id,
                floor_id: floor.floor_id,
                width: 15,
                description: faker.lorem.paragraphs(stryMutAct_9fa48("1979") ? {} : (stryCov_9fa48("1979"), {
                  min: 3,
                  max: 5
                })),
